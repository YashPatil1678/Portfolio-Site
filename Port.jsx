  ...
  return (
    <div className={`${theme.bg} ${theme.text} font-sans min-h-screen selection:bg-cyan-500 selection:text-white overflow-x-hidden transition-colors duration-300`}>
      ...
      <section id="about" className={`py-24 ${darkMode ? 'bg-slate-900/30' : 'bg-slate-100/50'} relative z-10 transition-colors duration-300`}>
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex items-center gap-4 mb-8">
             <h2 className={`text-4xl font-bold ${theme.heading}`}><span className="text-cyan-500">01.</span> About Me</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
             <div className={`col-span-2 ${darkMode ? 'bg-slate-800/50 border-slate-700' : 'bg-white border-slate-200 shadow-md'} p-8 rounded-2xl border backdrop-blur-sm hover:border-cyan-500/30 transition-all duration-300`}>
                ...
                <p className="text-lg leading-relaxed mb-6">
                  With <strong className="text-cyan-500">3.5+ years</strong> of experience at Infosys, I've helped scale systems for a major US Telecom client. 
                  My daily driver involves architecting secure VPCs, writing Terraform modules, and debugging Kubernetes pods.
                </p>
             ...
             <div className="space-y-4">
                {[{num: "3.5+", label: "Years Exp."}, {num: "10+", label: "Projects"}, {num: "3", label: "Certifications"}].map((stat, i) => (
      ...
      <section id="experience" className={`py-24 ${darkMode ? 'bg-slate-900/30' : 'bg-slate-100/50'} relative z-10 transition-colors duration-300`}>
        <div className="max-w-4xl mx-auto px-6">
          <h2 className={`text-4xl font-bold ${theme.heading} mb-16 text-center`}><span className="text-cyan-500">03.</span> Work Experience</h2>
          ...
          <div className={`relative border-l ${darkMode ? 'border-slate-700' : 'border-slate-300'} ml-6 md:ml-12 space-y-12`}>
            ...
            <div className="relative pl-12">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-2">
                <h3 className={`text-2xl font-bold ${theme.heading}`}>Senior Systems Associate</h3>
                <div className={`inline-block ${darkMode ? 'bg-cyan-900/30 text-cyan-300 border-cyan-800' : 'bg-cyan-50 text-cyan-700 border-cyan-200'} border text-xs px-3 py-1 rounded-full font-mono mt-2 md:mt-0`}>Jan 2024 – Present</div>
              </div>
              <h4 className={`text-xl ${darkMode ? 'text-slate-400' : 'text-slate-600'} mb-4 font-medium`}>Infosys Limited</h4>
              <p className={`${darkMode ? 'text-slate-400' : 'text-slate-500'} mb-4 italic text-sm`}>Project: US Telecom Client</p>
            ...
            <div className="relative pl-12">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-2">
                ...
                <div className={`inline-block ${darkMode ? 'bg-slate-800 text-slate-400 border-slate-700' : 'bg-slate-200 text-slate-600 border-slate-300'} border text-xs px-3 py-1 rounded-full font-mono mt-2 md:mt-0`}>Dec 2021 – Dec 2023</div>
              </div>
              <h4 className={`text-xl ${darkMode ? 'text-slate-400' : 'text-slate-600'} mb-4 font-medium`}>Infosys Limited</h4>
              <ul className={`list-disc list-outside ml-4 space-y-3 ${darkMode ? 'text-slate-300' : 'text-slate-600'} leading-relaxed`}>
      ...
      <section id="projects" className="py-24 relative z-10">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className={`text-4xl font-bold ${theme.heading} mb-12`}><span className="text-cyan-500">04.</span> Featured Projects</h2>
